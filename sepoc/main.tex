...
Os trabalhos que avaliam o efeito do pré-processamento sobre modelos convolucionais não convergem para uma conclusão única. Revisões sistemáticas da área registram tanto ganhos atribuídos ao tratamento prévio da imagem quanto situações em que esse tratamento é neutro ou prejudicial, e associam o resultado às características do conjunto de dados e da arquitetura empregada \cite{Salvi2021, sciencedirect2023normalization}.
