...
\palavrachave{Processamento de Imagens. Redes Neurais Artificiais. Aprendizado de Máquina. Métricas de Qualidade. Classificação de Imagens. Detecção de Objetos. Regressão. Dataset. Combinação de Processamentos. Otimização. Deep Learning. Segmentação de Imagens. Eficiência Computacional. Redes Convolucionais (CNN). Comparação de Modelos. Inteligência Artificial.}
