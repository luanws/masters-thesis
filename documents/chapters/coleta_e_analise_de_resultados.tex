...
\begin{itemize}
    \item \textbf{Espaço de Busca:} A busca foi realizada de forma uniforme, testando valores entre 0,5 e 3,0 em 5 etapas.
    ...
    \item \textbf{Atratividade Determinística:} Essa abordagem oferece alta reprodutibilidade científica, ao contrário de métodos heurísticos como o \textit{Random Search} ou modelos estocásticos em buscas bayesianas. Ela é adequada para explorações específicas ou cenários computacionais iniciais.
