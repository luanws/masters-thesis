...
Além desta introdução, esta dissertação está organizada em mais cinco capítulos. O Capítulo \ref{chap:trabalhos_relacionados} apresenta os trabalhos relacionados, discutindo estudos anteriores sobre detecção de falhas em isoladores e sobre a aplicação de processamento de imagem e aprendizado de máquina em problemas correlatos. O Capítulo \ref{chap:revisao_bibliografica} reúne a revisão bibliográfica, com os fundamentos teóricos de processamento de imagem e de redes neurais que embasam o estudo.
