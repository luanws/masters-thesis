...
\begin{table}[h!]
    ...
    \begin{tabular}{|l|c|c|c|c|c|c|c|c|c|c|c|}
        ...
        \hline
        \textbf{4. Implementação dos Modelos} &  &  &  &  &  &  &  &  &  \checkmark  &  &  \\
        \hline
        \textbf{5. Coleta e Análise de Resultados} &  &  &  &  &  &  &  &  & \checkmark & \checkmark &  \\
        \hline
        \textbf{6. Conclusão e Redação Final} &  &  &  &  &  &  &  &  &  & \checkmark & \checkmark \\
        \hline
